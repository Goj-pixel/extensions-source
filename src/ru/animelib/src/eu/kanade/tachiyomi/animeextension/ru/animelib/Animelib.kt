...
class Animelib : ParsedAnimeHttpSource() {
    ...
    // ИСПРАВЛЕНО: Сюда пишем адрес САЙТА, чтобы работал WebView и Referer
    ...
    // ИСПРАВЛЕНО: А вот сюда пишем адрес API для данных
    ...
    override fun headersBuilder(): Headers.Builder = super.headersBuilder()
        ...
        .add("site-id", siteId)
        .add("Referer", "$baseUrl/") // Теперь Referer будет правильным: v5.animelib.org
        .add("Origin", baseUrl)
        .add("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36")

    // Везде ниже используем apiUrl вместо baseUrl для запросов
